...
const terracottaCore = {
  ...
  /** Thriving badges — clay peach, darker than card shell so the pill reads on cream surfaces. */
  secondaryFixed: "#f0b8a0",
  secondaryFixedDim: "#e8a68c",
  onSecondary: "#ffffff",
...
export const terracottaDuskTheme: ThemeDefinition = {
  ...
  preview: {
    ...
    surfaces: {
      ...
      statusForeground: terracottaCore.primary,
